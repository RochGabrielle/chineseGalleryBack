 ...
 */
final class Version20200812135227 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, artist_id INT DEFAULT NULL, discount_id INT DEFAULT NULL, dynasty_id INT DEFAULT NULL, material_id INT NOT NULL, reference VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, birth SMALLINT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, smallpicturename VARCHAR(255) NOT NULL, bigpicturename VARCHAR(255) NOT NULL, status INT DEFAULT NULL, INDEX IDX_23A0E6612469DE2 (category_id), INDEX IDX_23A0E66B7970CF8 (artist_id), INDEX IDX_23A0E664C7C611F (discount_id), INDEX IDX_23A0E6681F5867E (dynasty_id), INDEX IDX_23A0E66E308AC6F (material_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE museum (id INT AUTO_INCREMENT NOT NULL, one_to_one_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, link VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_62474477B549C760 (one_to_one_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE theme (id INT AUTO_INCREMENT NOT NULL, placeholder VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
